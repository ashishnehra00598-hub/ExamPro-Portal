...
export default function StudentTestScreen() {
  ...
  // टेस्ट सबमिट और तुरंत एनालिसिस व लीडरबोर्ड लोड
  const handleSubmitTest = async () => {
    ...
    setScoreResult(resultSummary);

    // 1. Supabase में रिजल्ट स्टोर करें
    try {
      ...
      // 2. तुरंत इस टेस्ट का लीडरबोर्ड लोड करें
  ...
  // ==========================================
  // 1. टेस्ट सबमिशन के बाद का रिजल्ट + सॉल्यूशन + लीडरबोर्ड व्यू
  // ==========================================
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-gradient-to-r from-slate-900 to-indigo-950 border border-slate-800 rounded-3xl p-6 text-center shadow-2xl">
            ...
            <button
              ...
              className="mt-6 text-xs bg-slate-800 hover:bg-slate-700 text-slate-200 px-5 py-2.5 rounded-xl border border-slate-700 transition"
            >
              ← वापस डैशबोर्ड जाएँ
            </button>
          </div>

          {/* Tab Selector: Solutions vs Leaderboard */}
          <div className="flex bg-slate-900 border border-slate-800 p-1.5 rounded-2xl">
            ...
            >
              📝 सभी प्रश्नों के उत्तर व हल (Answer Key & Solutions)
            </button>
            <button
          ...
          {/* TAB 1: Detailed Question-by-Question Solution */}
          {activeTab === 'solutions' && (
  ...
  // ==========================================
  // 2. लाइव टेस्ट इंटरफ़ेस (Exam Mode)
  // ==========================================
      ...
      <div className="max-w-4xl mx-auto w-full space-y-4">
        ...
        <div className="flex justify-between items-center gap-2">
          <button
            ...
            className="px-4 py-2.5 bg-slate-900 border border-slate-800 disabled:opacity-40 rounded-xl text-xs font-bold text-slate-300"
          >
            ← पिछला
          </button>
          ...
          {currentQIndex < questions.length - 1 ? (
            ...
            <button
              ...
              className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-500 rounded-xl text-xs font-bold text-white shadow-lg animate-pulse"
            >
